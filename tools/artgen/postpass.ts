...
const VARIANTS: Record<string, { base: string; ramps: Record<string, string> }> = {
  ...
  clockwork_brass_bed_brass: { base: "clockwork_brass_bed", ramps: { walnut: "gold", crimson: "crimson", slate: "slate" } },
  clockwork_gauge_console_copper: { base: "clockwork_gauge_console", ramps: { charcoal: "slate", gold: "signal" } },
  clockwork_winding_desk_iron: { base: "clockwork_winding_desk", ramps: { walnut: "charcoal", gold: "slate" } },
  clockwork_boiler_cart_steam: { base: "clockwork_boiler_cart", ramps: { gold: "slate", walnut: "crimson" } },
  clockwork_piston_chair_oil: { base: "clockwork_piston_chair", ramps: { gold: "slate", slate: "charcoal" } },
  clockwork_escapement_cabinet_rust: { base: "clockwork_escapement_cabinet", ramps: { walnut: "crimson" } },
  clockwork_mainspring_bench_ivory: { base: "clockwork_mainspring_bench", ramps: { slate: "ivory" } },
  clockwork_pipe_shelf_cobalt: { base: "clockwork_pipe_shelf", ramps: { charcoal: "navy" } },
  clockwork_gear_table_ember: { base: "clockwork_gear_table", ramps: { gold: "crimson", slate: "charcoal" } },
  clockwork_steam_lamp_ash: { base: "clockwork_steam_lamp", ramps: { gold: "slate" } },
  clockwork_copper_rug_gold: { base: "clockwork_copper_rug", ramps: { walnut: "gold" } },
  clockwork_cog_stool_slate: { base: "clockwork_cog_stool", ramps: { gold: "ivory" } },
  clockwork_brass_bed_verdigris: { base: "clockwork_brass_bed", ramps: { gold: "teal", crimson: "teal", walnut: "teal", slate: "slate" } },
  clockwork_gauge_console_coal: { base: "clockwork_gauge_console", ramps: { gold: "slate", slate: "charcoal" } },
  clockwork_winding_desk_amber: { base: "clockwork_winding_desk", ramps: { gold: "gold", charcoal: "slate" } },
  clockwork_boiler_cart_tin: { base: "clockwork_boiler_cart", ramps: { walnut: "slate", gold: "ivory" } },
  clockwork_piston_chair_mahogany: { base: "clockwork_piston_chair", ramps: { slate: "crimson", gold: "walnut" } },
  clockwork_escapement_cabinet_pearl: { base: "clockwork_escapement_cabinet", ramps: { walnut: "ivory", charcoal: "ivory" } },
